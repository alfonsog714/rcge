...
/* Includes for Vulkan (surface creation mainly)*/
    ...
    i32 height)
{
    ...
    wc.lpszClassName = "rcge_window_class";
    ...
    HWND handle = CreateWindowExA(
        window_ex_style, "rcge_window_class", application_name,
    ...
    if (handle == 0)
    {
        ...
        RCFATAL("Window creation failed!");
        return FALSE;
    }
    else
    {
...
b8 platform_create_vulkan_surface(platform_state *plat_state, vulkan_context *context)
{
    ...
    {
        RCFATAL("Vulkan surface creation failed.");
        return FALSE;
    }
