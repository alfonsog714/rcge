 ...
 * u64 stride = the size of each element in bytes
 * void *elements = the array of elements itself
 */
...
RCAPI void *_darray_insert_at(void *array, u64 index, void *value_ptr);
