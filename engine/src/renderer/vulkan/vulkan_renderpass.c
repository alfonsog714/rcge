...
#define attachment_description_count 2
    ...
    VkAttachmentReference depth_attacchment_reference = {};
    depth_attacchment_reference.attachment = 1;
    depth_attacchment_reference.layout = VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL;

    /* TODO: Other attachment types: input, resolve, preserve, etc */

    subpass.pDepthStencilAttachment = &depth_attacchment_reference;
    ...
    VkFramebuffer frame_buffer)
{
    ...
    rczero_memory(clear_values, sizeof(VkClearValue) * 2);
